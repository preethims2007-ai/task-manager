    ...
    return (
        <section className="relative max-w-5xl md:min-h-[80vh] mx-auto px-4 py-24 overflow-hidden">
            <div className="text-center mb-16 animate-slide-up">
                ...
                <p className="text-muted-foreground max-w-xl mx-auto">SEO_Pulse uses advanced browser automation and AI to simulate a real user experience and provide deep SEO insights.</p>
            </div>
