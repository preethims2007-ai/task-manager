            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <Link to="/" className="flex items-center justify-center gap-2 group mb-10">
                        ...
                        <span className="text-xl tracking-tight text-foreground">SEO_Pulse</span>
                    </Link>
                </div>
                ...
                <div className="bg-card border border-border rounded-2xl p-8">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="text-center py-5">
                            ...
                            <p className="text-muted-foreground text-sm mt-1">{isLoginState ? "Sign in to your" : "Create an"} SEO_Pulse account</p>
                        </div>
